...
if(isset($_POST['save_list'])){
   // Existing bookmark code remains the same
}
      ...
      <?php
         ...
         if($select_content->rowCount() > 0){
            while($fetch_content = $select_content->fetch(PDO::FETCH_ASSOC)){  
               $is_free = $fetch_content['is_free']; // Assuming you have this column in your content table
      ?>
      <div class="box">
         ...
         <?php if ($is_free) { ?>
            <a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>" class="watch-btn">Watch Now</a>
         <?php } else { ?>
            <p>This content is available only with a purchased playlist. Please purchase the playlist to view this content.</p>
         <?php } ?>
      </div>
      <?php
            }
